...
import com.nttdata.utils.ControlsExecutionParallelAgents;
...
public class TestRunner {
    ...
    public void testRunner() throws IOException {
        ...
        Results results = Runner.path("src/test/java/com/nttdata")
    ...
    public static void generateReport(String karateOutputPath) throws IOException {
        ...
        Configuration config = new Configuration(new File("build"), "nttdata");
